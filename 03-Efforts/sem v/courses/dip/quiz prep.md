...
- [ ] **Q1–Q4:** Image formation, Bayer filter pattern, photosites, quantization, and camera aperture effects
- [ ] **Q5–Q6:** Intensity transformations and histogram properties of binary images
- [ ] **Q7–Q11, Q13–Q14:** Spatial filtering, neighborhoods (4/8/D), padding calculation, mean / LoG / unsharp masks, and non-linear median filtering
- [ ] **Q12:** Linear Shift-Invariant (LSI) system properties
- [ ] **Q15:** Fourier transform of standard continuous/discrete functions
...
### Relevant
- [ ] **Q1 (Parts 1, 2*, 3*, 4*):** Spatial filter symmetry, FT of impulse function, band-limited vs. spatial-limited properties, and 2D Fourier rotation property
- [ ] **Q2:** Histogram properties and image spatial arrangement invariance
...
- [ ] **Q6:** Spatial high-pass filter kernel structure (center impulse / zero-sum)
...
### Relevant
- [ ] **Q1 (Parts 1, 2*, 3*, 4*):** Difference of Gaussians (DoG) approximation, FT of shifted impulse $\delta(t - \tau)$, aliasing reduction techniques, and homomorphic filtering
...
### Relevant
- [ ] **Q1 (a, b):** Bilateral filtering equations, range/spatial kernels, and conditions approaching Gaussian filtering
- [ ] **Q2 (a, b*):** Spatial finite differences vs. derivative computation using DFT properties
- [ ] **Q3* (a, b):** Image sampling, aliasing phenomena during capture/reconstruction, and anti-aliasing techniques
